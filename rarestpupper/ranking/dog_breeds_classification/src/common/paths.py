...
JPEG_EXT = '.jpg'
DATA_ROOT = 'ranking/dog_breeds_classification/data/'
...
IMAGENET_GRAPH_DEF = 'ranking/dog_breeds_classification/frozen/inception/classify_image_graph_def.pb'
TEST_PREDICTIONS = 'predictions.csv'
METRICS_DIR = 'metrics'
TRAIN_CONFUSION = os.path.join(METRICS_DIR, 'training_confusion.csv')
FROZEN_MODELS_DIR = 'ranking/dog_breeds_classification/frozen'
